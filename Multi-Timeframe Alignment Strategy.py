...
class MultiTimeframeAlignmentNexusAdapter:
    ...
    def __init__(
        ...
        # Connect ProductionSequentialPipeline if NEXUS AI available
        self.ml_pipeline = None
        ...
        if NEXUS_AI_AVAILABLE:
            try:
                self.ml_pipeline = ProductionSequentialPipeline(
                    strategies=[self.base_strategy],
                    enable_ml_enhancement=True
                )
                self._pipeline_connected = True
                logging.info("✓ ML Pipeline actively connected (ProductionSequentialPipeline)")
            except Exception as e:
    ...
    def _get_ml_prediction(
        ...
        """
        Get ML prediction using ProductionSequentialPipeline.
        ...
        try:
            ...
            # Call ProductionSequentialPipeline for ML-enhanced predictions
...
if NEXUS_AI_AVAILABLE:
    try:
        ...
        StrategyRegistry.register(
            ...
            strategy_class=MultiTimeframeAlignmentNexusAdapter,
            category="trend_following",
            version="3.0.0",
            capabilities={
                'mqscore_aware': True,
                'mqscore_6d_integrated': True,
                'ml_enhanced': True,
        ...
        logger.info("✅ Multi-Timeframe Alignment Strategy registered with NEXUS AI orchestrator")
        ...
        logger.warning(f"Strategy registration failed: {e} - continuing without registration")
else:
    logger.info("⚠️ Strategy not registered - NEXUS AI unavailable (running in fallback mode)")